...
export default function CloneClasses({data}) {
  ...
  var subtreeClonesType1Classes = data?.subtreeClones?.type1?.classes;
  var subtreeClonesType2Classes = data?.subtreeClones?.type2?.classes;
  var subtreeClonesType3Classes = data?.subtreeClones?.type3?.classes;
